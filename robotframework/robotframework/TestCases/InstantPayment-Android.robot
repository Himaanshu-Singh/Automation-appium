...
${instant_pay_btn}     xpath=(//android.view.ViewGroup[@content-desc="Instant Book"])[1]
${uniOne}                xpath=//android.view.ViewGroup[@content-desc="Other_Uni_1"]/android.view.ViewGroup
${pay_btn_stripe}        xpath=//android.view.ViewGroup[@content-desc="Pay £1.04"]
${card_number_field}        xpath=//android.widget.EditText[@resource-id="com.universityliving:id/card_number_edit_text"]
${card_expiry_field}        xpath=//android.widget.EditText[@resource-id="com.universityliving:id/expiry_date_edit_text"]
${card_cvc}                    xpath=//android.widget.EditText[@resource-id="com.universityliving:id/cvc_edit_text"]
${final_pay_btn}                xpath=//android.view.ViewGroup[@content-desc="Pay £1.04"]
${congratulation_continue}        xpath=//android.view.ViewGroup[@content-desc="Continue"]

################# WORLDPAY  ##########
${wp_name}               //android.widget.EditText[@content-desc="Name"]
${wp_cardNumber}         //android.widget.EditText[@content-desc="Card_Number_Field"]
${wp_date}               //android.widget.EditText[@content-desc="Expiry_Date_Field"]
${wp_cvv}                //android.widget.EditText[@content-desc="CVV_Field"]
${wp_pay}                //android.view.ViewGroup[@content-desc="Pay £1.04"]
${wp_conti}              //android.view.ViewGroup[@content-desc="Continue"]
...
*** Test Cases ***
Test Case InstantPayement-Stripe
...
################### selection skup in onboarding journey ################################## 
    Custom Wait And Click    ${skip_journey}

################### Home screen handling and searching test dev purpose #####################################
...
################## handling instant payment form  ################################## 
    Custom Wait And Click    ${instant_pay_btn}
    ...
    Swipe    start_x=400    start_y=1300    offset_x=400    offset_y=400    duration=2000
    ...
    # Capture SS    ${filename}paymentInfo_instantPayment.png
    # Custom Wait And Click    ${first_name}
    Custom Wait And Click    ${pay_btn_stripe}

################### handling card input information ################################## 
    Custom Wait And Input Text        ${wp_name}            Test
    Custom Wait And Input Text    ${wp_cardNumber}    4000000000001000
    Custom Wait And Input Text    ${wp_date}    6745
    Custom Wait And Input Text    ${wp_cvv}    124
    Custom Wait And Click    ${wp_pay}
    Custom Wait And Click     ${wp_conti}

################### continuing to complete booking flow ################################## 
...
################## Guardian Info screen ###############################
    ...
    Capture SS    ${filename}successfullBookingInstantPay.png
    Sleep    3s
    Close Application
