...
#${test_dev}                     //android.view.ViewGroup[@content-desc="Test (Dev Purpose), United Kingdom"]
...
#######JoinWaitlist######
${join_wait_list}                    //android.view.ViewGroup[@content-desc="Join Waitlist"]
...
*** Test Cases ***
Test Case JoinwaitList Form
    Open Application    http://localhost:4723     platformName=Android    deviceName='75sk5dl7kzay75on'  appPackage=com.universityliving     appActivity=com.universityliving.MainActivity   automationName=UiAutomator2
    TRY
    ...
    Swipe    start_x=400    start_y=1300    offset_x=400    offset_y=400    duration=2000
    Custom Wait And Click        ${join_wait_list}
    Sleep     10s  
